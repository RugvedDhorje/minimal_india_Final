...
export const MacbookScroll = ({
  ...
  return (
    <>
      <div
        ref={ref}
        className="min-h-[200vh] flex bg-gradient-to-t from-white to-[foo-white] flex-col items-center py-0 md:pt-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
      >
        <motion.h2
          style={{
