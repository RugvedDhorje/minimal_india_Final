...
//       <div
//         ref={ref}
//         className="min-h-[240vh] flex bg-gradient-to-t from-white to-[foo-white] flex-col items-center py-0 md:pt-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
//       >
//         {/* <motion.h2
//           style={{
...
//     [0.5, isMobile ? 1 : 1.5]
//   );
//   const translate = useTransform(scrollYProgress, [0, 0.2], [0, 500]);
...
//     <div
//       ref={ref}
//       className="lg:min-h-[120vh] sm:min-h-[150vh] flex flex-col items-center py-0 md:pb-80 md:pt-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 overflow-hidden"
//     >
//       {/* Lid */}
//       <Lid
//         src={src}
...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.7], [0, 500]);
  const rotate = useTransform(scrollYProgress, [0.1, 0.12, 0.3], [-28, -28, 0]);

  return (
    <div
      ref={ref}
      className="lg:min-h-[120vh] sm:min-h-[100vh] flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 overflow-hidden"
    >
      {/* Lid */}
      <Lid
        src={src}
