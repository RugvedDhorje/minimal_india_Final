...
export default function CodeProject() {
  ...
  return (
    <section className="max-w-screen-2xl mx-auto z-50 w-full flex flex-col items-center justify-center h-screen relative bg-gradient-to-r from-[#130C0B] to-[#0C0807]">
